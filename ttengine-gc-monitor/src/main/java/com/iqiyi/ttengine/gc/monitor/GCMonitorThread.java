 ...
 */
public class GCMonitorThread extends Thread {

    private static Logger logger = LoggerFactory.getLogger(GCMonitorThread.class);
    ...
    private static GCMonitorThread instance = new GCMonitorThread();

    protected static GCMonitorThread getInstance() {
        return instance;
    }
